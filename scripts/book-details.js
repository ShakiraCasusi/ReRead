...
function displayBookDetails(book) {
    ...
    const imageSrc =
        book.image && (book.image.startsWith("http") || book.image.startsWith("data:"))
            ? book.image
    ...
    document.getElementById("bookOriginalPrice").textContent = book.originalPrice;
...
function initializeEventListeners() {
    ...
    // Add to cart button
    document.getElementById("addToCartBtn").addEventListener("click", addCurrentBookToCart);

    // Wishlist button
    document.querySelector(".btn-outline-secondary:has(i.fa-heart)").addEventListener("click", () => {
...
function addCurrentBookToCart() {
    ...
    updateCartBadge();
    showNotification(`${quantity}x ${currentBook.title} added to cart!`, "success");
